...
dates = [dates[i] - dates[0] for i in range(len(dates))]
dates = [x.days for x in dates] 
...
## Inspecting data
#plt.plot(dates, novelty, markersize=8, alpha=0.4)
#plt.ylabel("novelty")
#plt.xlabel("date") 
#plt.title("")
...
plt.plot(dates, novelty, ".", alpha=0.6)
plt.ylabel("novelty")
plt.xlabel("days") 
...
plt.plot(dates, average_novelty, "k--", lw=2)
plt.title('')
